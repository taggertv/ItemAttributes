...
public interface IAttributeHandler {
   ...
   */
  IAttributeValue getAttributeValueFromItemStack(ItemStack itemStack, IAttribute attribute);
   ...
   * @return value of IAttribute on ItemStack
   */
  IAttributeValue getAttributeValueFromEntity(LivingEntity livingEntity, IAttribute attribute);
